...
1. Откройте каталог → страница нужного компонента (Button, Input, Checkbox, Radio, Badge).
2. Нажмите «Копировать» под нужным примером.
3. Вставьте фрагмент в `.screen` своего прототипа.
4. Поменяйте текст, добавьте/уберите иконки — **не меняя классы**.
5. Откройте файл в браузере (двойной клик) или на локальном сервере.
...
- Каталог компонентов: https://anders7rusk.github.io/iiko-ds-web/
- Страницы компонентов: button.html · input.html · checkbox.html · radio.html · badge.html
